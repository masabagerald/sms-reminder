...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.mother.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mothers.update", [$mother->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.mother.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $mother->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" type="number" name="age" id="age" value="{{ old('age', $mother->age) }}" step="1" required>
                @if($errors->has('age'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Mother::MARITAL_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('marital_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="marital_status_{{ $key }}" name="marital_status" value="{{ $key }}" {{ old('marital_status', $mother->marital_status) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $mother->village) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parish') ? 'is-invalid' : '' }}" type="text" name="parish" id="parish" value="{{ old('parish', $mother->parish) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subcounty') ? 'is-invalid' : '' }}" type="text" name="subcounty" id="subcounty" value="{{ old('subcounty', $mother->subcounty) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anc_no') ? 'is-invalid' : '' }}" type="text" name="anc_no" id="anc_no" value="{{ old('anc_no', $mother->anc_no) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Mother::HIV_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('hiv_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="hiv_status_{{ $key }}" name="hiv_status" value="{{ $key }}" {{ old('hiv_status', $mother->hiv_status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Mother::NEWLY_TESTED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('newly_tested') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="newly_tested_{{ $key }}" name="newly_tested" value="{{ $key }}" {{ old('newly_tested', $mother->newly_tested) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Mother::NEWLY_ART_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('newly_art') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="newly_art_{{ $key }}" name="newly_art" value="{{ $key }}" {{ old('newly_art', $mother->newly_art) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('edd') ? 'is-invalid' : '' }}" type="text" name="edd" id="edd" value="{{ old('edd', $mother->edd) }}" required>
                @if($errors->has('edd'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $mother->notes) }}</textarea>
                @if($errors->has('notes'))
